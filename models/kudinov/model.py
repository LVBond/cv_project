...
class UNet(nn.Module):
    def __init__(self, n_class):
        ...
        self.pool2 = nn.MaxPool2d(kernel_size=2, stride=2)  # output: 143x143x128

        self.e31 = nn.Conv2d(128, 256, kernel_size=3, padding=1)  # output: 143x143x256
        self.e32 = nn.Conv2d(256, 256, kernel_size=3, padding=1)  # output: 143x143x256
        ...
        # Decoder
        self.upconv1 = nn.ConvTranspose2d(1024, 512, kernel_size=2, stride=2)  # output: 72x72x512
        self.d11 = nn.Conv2d(1024, 512, kernel_size=3, padding=1)
        self.d12 = nn.Conv2d(512, 512, kernel_size=3, padding=1)

        self.upconv2 = nn.ConvTranspose2d(512, 256, kernel_size=2, stride=2)  # output: 144x144x256
        self.d21 = nn.Conv2d(512, 256, kernel_size=3, padding=1)
        self.d22 = nn.Conv2d(256, 256, kernel_size=3, padding=1)

        self.upconv3 = nn.ConvTranspose2d(256, 128, kernel_size=2, stride=2)  # output: 288x288x128
        self.d31 = nn.Conv2d(256, 128, kernel_size=3, padding=1)
        self.d32 = nn.Conv2d(128, 128, kernel_size=3, padding=1)

        self.upconv4 = nn.ConvTranspose2d(128, 64, kernel_size=2, stride=2)  # output: 576x576x64
